...
/**This is to find a worker in the interface maintenance repair maintenance report*/ 
$(document).ready(function(){
...
document.getElementById("textarea").value="TV not working";
document.getElementById("reportdate").value="12/05/2020";
